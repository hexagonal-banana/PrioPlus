#ifndef CREDIT_SPRAY_H
#define CREDIT_SPRAY_H
...
namespace ns3{
    ...
    class RoCEv2CreditSpray : public RoCEv2CreditCc
    {
    public:

    static TypeId GetTypeId();
    RoCEv2CreditSpray();
    RoCEv2CreditSpray(Ptr<RoCEv2SocketState> sockState);
    ~RoCEv2CreditSpray() override;
    ...
    std::queue<PathTag> m_senderPathTagList;
    //PathTag m_dataPathTag;
};
}

#endif // CREDIT_SPRAY_H