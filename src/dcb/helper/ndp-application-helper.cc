                                             ...
                                             Ptr<DcTopology> topology)
{
    ...
    {
        nodeSpec = std::string(appConfig.at("nodes").as_string());
    }
    else
    {
    ...
    {
        std::string patternStr = std::string(appCfg.at("TrafficPattern").as_string());
    ...
    {
        startTime = Time(std::string(appConfig.at("startTime").as_string()));
    }

    Time stopTime = Seconds(0.0);
    if (appConfig.contains("stopTime"))
    {
        stopTime = Time(std::string(appConfig.at("stopTime").as_string()));
    }
    ...
    for (uint32_t nodeIdx : nodeIndices)
    {
        ...
        if (appConfig.contains("ndpConfig"))
        {
            ...
            {
                DataRate overrideRate(std::string(ndpConfig.at("pullLinkRate").as_string()));
                                     ...
                                     Ptr<NdpTrafficGenApplication> app)
{
    ...
    {
        std::string rateStr = std::string(ndpConfig.at("receiverLinkRate").as_string());
                                           ...
                                           Ptr<NdpTrafficGenApplication> app)
{
    ...
    {
        std::string selection = std::string(multipathConfig.at("pathSelection").as_string());
                                      ...
                                      Time stopTime)
{
    ...
    std::string cdfFile = std::string(cdfObj.at("cdfFile").as_string());
                                                ...
                                                Ptr<DcTopology> topology)
{
    ...
    {
        baseNetwork = std::string(multipathConfig.at("baseNetwork").as_string());
    }

    std::string networkMask = "255.255.0.0";
    if (multipathConfig.contains("networkMask"))
    {
        networkMask = std::string(multipathConfig.at("networkMask").as_string());
    }
    ...
    {
        topoType = std::string(multipathConfig.at("topology").as_string());
    }
